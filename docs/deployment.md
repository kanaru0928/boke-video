...
| `deploy/ovenmediaengine/Server.xml.example` | OvenMediaEngine設定テンプレート |
...
sudo install -m 644 deploy/ovenmediaengine/Server.xml /usr/share/ovenmediaengine/conf/Server.xml
