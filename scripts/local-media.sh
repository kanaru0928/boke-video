...
perl -0pi -e 's/\*:10000-10005\/tcp/127.0.0.1:10000-10005\/tcp/g' "${CONF_DIR}/Server.xml"
perl -0pi -e 's/<DefaultTransport>udp<\/DefaultTransport>/<DefaultTransport>tcp<\/DefaultTransport>/g' "${CONF_DIR}/Server.xml"
