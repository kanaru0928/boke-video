...
export function ObsWebsocketSettings({
  ...
  return (
    <Board icon={Cable} title="OBS WebSocket接続">
      <section className="relative border border-t-0 border-[#c2c2c2] bg-[#f7f7f7] p-2">
        <div className="grid grid-cols-[auto_minmax(130px,1fr)_auto_80px_auto_minmax(150px,1fr)_auto] items-center gap-[7px] max-[700px]:grid-cols-[auto_minmax(0,1fr)] max-[700px]:items-start">
        ...
        <AdminStatusLine
          className="absolute right-2 bottom-[calc(100%+4px)] z-10"
          message={saved ? "OBS WebSocket接続情報を保存しました。" : ""}
          tone="success"
        />
      </section>
    </Board>
